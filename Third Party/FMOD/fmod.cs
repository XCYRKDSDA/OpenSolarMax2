...
#pragma warning restore 414
    ...
    */
    public struct System
    {
        ...
        {
            return FMOD5_System_SetSoftwareFormat(
                this.handle,
                samplerate,
                speakermode,
                numrawspeakers
        ...
        {
            return FMOD5_System_AttachFileSystem(
                this.handle,
                useropen,
                userclose,
                userread,
        ...
        {
            return FMOD5_System_SetStreamBufferSize(
                this.handle,
                filebuffersize,
                filebuffersizetype
            );
        ...
        {
            return FMOD5_System_Set3DSettings(
                this.handle,
                dopplerscale,
                distancefactor,
                rolloffscale
    ...
    */
    public struct Channel : IChannelControl
    {
        ...
        {
            return FMOD5_Channel_Get3DOcclusion(
                this.handle,
                out directocclusion,
                out reverbocclusion
            );
    ...
    */
    public struct ChannelGroup : IChannelControl
    {
        ...
        {
            return FMOD5_ChannelGroup_SetDelay(
                this.handle,
                dspclock_start,
                dspclock_end,
                stopchannels
        ...
        public RESULT set3DDistanceFilter(bool custom, float customLevel, float centerFreq)
        {
            return FMOD5_ChannelGroup_Set3DDistanceFilter(
                this.handle,
                custom,
                customLevel,
                centerFreq
    ...
    */
    public struct DSP
    {
        ...
        {
            return FMOD5_DSP_GetInput(
                this.handle,
                index,
                out input.handle,
                out inputconnection.handle
            );
        }
        ...
        {
            return FMOD5_DSP_GetParameterData(
                this.handle,
                index,
                out data,
                out length,
    ...
    */
    public struct Reverb3D
    {
        ...
        {
            return FMOD5_Reverb3D_Set3DAttributes(
                this.handle,
                ref position,
                mindistance,
                maxdistance
