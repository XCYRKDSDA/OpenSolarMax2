...
[ReadCurr(typeof(ExpireAfterAnimationCompleted)), ReadCurr(typeof(Animation)), DelayedCalc]
public sealed partial class ExpireAnimationCompletedEntitiesSystem(World world) : IDelayedCalcSystem
{
    [Query]
